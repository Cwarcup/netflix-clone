// selected is a boolean that is passed in as a prop. If selected is true, the opacity of the path is set to 1, otherwise it is set to 0. This is how we can change the color of the icon when it is selected or not.

const DislikeIcon = ({ selected = false }) => (
  <svg
